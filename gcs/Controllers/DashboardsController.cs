...
namespace gcs.Controllers
{
    public class DashboardsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description")] Dashboard dashboard)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description")] Dashboard dashboard)
        {
            if (id != dashboard.Id)
            {
                return NotFound();
